...
default_args = {
 ...
 'solutionname': 'cybersecurity160-4940',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_cybersecurity160-4940", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cybersecurity160-4940"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
